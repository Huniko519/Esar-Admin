...
class ReviewsController extends Controller
{
    ...
    public function search($search, Request $request)
    {
        try {
            ...
            $requestData = ['id','trip_id','owner_id','renter_id','created_at','updated_at'];
    ...
    public function update(Request $request, $id)
    {
        try {
           ...
           $reviews->trip_id = $input['trip_id'];$reviews->owner_id = $input['owner_id'];$reviews->renter_id = $input['renter_id'];$reviews->created_at = $input['created_at'];$reviews->updated_at = $input['updated_at'];
