...
import getColumns from './CarsColumns';
import Edit from "@material-ui/icons/Edit";
import { Switch } from "@material-ui/core";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deleteCars, getCars} from "../../repo/carsRepo";
...
const CarsTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {   setLoading(true);
                const res = await getCars(query.page,query.pageSize,query.search);
                setLoading(false);
                return ({
                    data: res.data,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/cars/update/${rowData.id}`,
                        user:rowData
                    })
                }
            },
