...
import getColumns from './AdminsColumns';
import Edit from "@material-ui/icons/Edit";
import { Switch } from "@material-ui/core";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deleteAdmins, getAdmins} from "../../repo/adminsRepo";
...
const AdminsTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {   setLoading(true);
                const res = await getAdmins(query.page,query.pageSize,query.search);
                setLoading(false);
                return ({
                    data: res.data,
                    page: query.page,
