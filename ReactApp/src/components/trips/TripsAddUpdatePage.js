...
import {addTrips, getTrips,getOneTrips, updateTrips} from "../../repo/tripsRepo";
...
const TripsAddUpdatePage = (props)=>{
...
const [cars,setCars] = useState(undefined)
    ...
    const checkErrors = () => {
        let errorList = {}
        if(trips.owner_id === "" || trips.owner_id === undefined)
{
   errorList = { ...errorList,owner_id: "Required field!"}
}
if(trips.car_id === "" || trips.car_id === undefined)
{
   errorList = { ...errorList,car_id: "Required field!"}
}
if(trips.renter_id === "" || trips.renter_id === undefined)
{
   errorList = { ...errorList,renter_id: "Required field!"}
}
if(trips.delivery_on_airport === "" || trips.delivery_on_airport === undefined)
{
   errorList = { ...errorList,delivery_on_airport: "Required field!"}
}
if(trips.delivery_on_car_location === "" || trips.delivery_on_car_location === undefined)
{
   errorList = { ...errorList,delivery_on_car_location: "Required field!"}
}
if(trips.delivery_on_renter_location === "" || trips.delivery_on_renter_location === undefined)
{
   errorList = { ...errorList,delivery_on_renter_location: "Required field!"}
}
if(trips.renter_confirm_trip === "" || trips.renter_confirm_trip === undefined)
{
   errorList = { ...errorList,renter_confirm_trip: "Required field!"}
}
if(trips.owner_confirm_trip === "" || trips.owner_confirm_trip === undefined)
{
   errorList = { ...errorList,owner_confirm_trip: "Required field!"}
}
if(trips.status === "" || trips.status === undefined)
{
   errorList = { ...errorList,status: "Required field!"}
}
if(trips.trip_modified === "" || trips.trip_modified === undefined)
{
   errorList = { ...errorList,trip_modified: "Required field!"}
}
if(trips.is_trip_modified === "" || trips.is_trip_modified === undefined)
{
   errorList = { ...errorList,is_trip_modified: "Required field!"}
}
if(trips.i_agree === "" || trips.i_agree === undefined)
{
...
getCars(0,200,"").then((res)=>{ setCars(res.data); setLoading(false); })
        ...
        if(props.match.params.id) {
            setLoading(true);
            getOneTrips(props.match.params.id).then((res) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(Object.keys(errors).length<1) {
            if (trips.id) {
            setLoading(true);
               var updateResponse =  await updateTrips(trips.id,trips);
               setLoading(false);
            ...
            setLoading(true);
                var addResponse = await addTrips(trips);
                setLoading(false);
    ...
    return(
        <PageTemplate title="Add/Update Trips">
            <Card>
            <CardContent>
                <form onSubmit={handleSubmit} noValidate autoComplete="off">
               
                    {(trips!==undefined  && users!==undefined && cars!==undefined && users!==undefined)?
                        <Grid spacing={3} container>
                           <Grid xs={12} md={6} key={"0"} item>
<TextField  autoFocus fullWidth
helperText ={errorMessages.chat_id}
type ={"text"}
onChange={(e)=>{setTrips({...trips,chat_id:e.target.value});checkErrors()}}
defaultValue ={trips.chat_id}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,delivery_on_airport:e.target.value});checkErrors()}}
defaultValue ={trips.delivery_on_airport}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,airport_id:e.target.value});checkErrors()}}
defaultValue ={trips.airport_id}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,delivery_on_car_location:e.target.value});checkErrors()}}
defaultValue ={trips.delivery_on_car_location}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,delivery_on_renter_location:e.target.value});checkErrors()}}
defaultValue ={trips.delivery_on_renter_location}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,long_location:e.target.value});checkErrors()}}
defaultValue ={trips.long_location}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,lat_location:e.target.value});checkErrors()}}
defaultValue ={trips.lat_location}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,pickup_location:e.target.value});checkErrors()}}
defaultValue ={trips.pickup_location}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,notice_time:e.target.value});checkErrors()}}
defaultValue ={trips.notice_time}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,booked_instantly:e.target.value});checkErrors()}}
defaultValue ={trips.booked_instantly}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,renter_confirm_trip:e.target.value});checkErrors()}}
defaultValue ={trips.renter_confirm_trip}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,owner_confirm_trip:e.target.value});checkErrors()}}
defaultValue ={trips.owner_confirm_trip}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,status:e.target.value});checkErrors()}}
defaultValue ={trips.status}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,telr_cancel:e.target.value});checkErrors()}}
defaultValue ={trips.telr_cancel}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,renter_confirm_trip_update:e.target.value});checkErrors()}}
defaultValue ={trips.renter_confirm_trip_update}
...
type ={"text"}
onChange={(e)=>{setTrips({...trips,owner_confirm_trip_update:e.target.value});checkErrors()}}
defaultValue ={trips.owner_confirm_trip_update}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,telr_cancel_modification:e.target.value});checkErrors()}}
defaultValue ={trips.telr_cancel_modification}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,trip_modified:e.target.value});checkErrors()}}
defaultValue ={trips.trip_modified}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,is_trip_modified:e.target.value});checkErrors()}}
defaultValue ={trips.is_trip_modified}
...
type ={"number"}
onChange={(e)=>{setTrips({...trips,i_agree:e.target.value});checkErrors()}}
defaultValue ={trips.i_agree}
...
onChange={(e)=>{setTrips({...trips,start_date:e.target.value});checkErrors()}}
defaultValue ={trips.start_date}
...
type ={"datetime-local"}
InputLabelProps ={{ shrink: true, }}
onChange={(e)=>{setTrips({...trips,end_date:e.target.value});checkErrors()}}
defaultValue ={trips.end_date}
...
type ={"datetime-local"}
InputLabelProps ={{ shrink: true, }}
onChange={(e)=>{setTrips({...trips,created_at:e.target.value});checkErrors()}}
defaultValue ={trips.created_at}
...
type ={"datetime-local"}
InputLabelProps ={{ shrink: true, }}
onChange={(e)=>{setTrips({...trips,updated_at:e.target.value});checkErrors()}}
defaultValue ={trips.updated_at}
...
<InputLabel style={{textAlign: 'left'}}>owner_id</InputLabel>
        <Select style={{width: '100%',textAlign: 'left'}}
                              labelId ="owner_id"
                              id="owner_id"
                              value={trips.owner_id}
                              onChange ={(e)=>{setTrips({...trips,owner_id:e.target.value});checkErrors()}}>
...
<InputLabel style={{textAlign: 'left'}}>car_id</InputLabel>
        <Select style={{width: '100%',textAlign: 'left'}}
                              ...
                              id="car_id"
                              value={trips.car_id}
                              onChange ={(e)=>{setTrips({...trips,car_id:e.target.value});checkErrors()}}>
...
<InputLabel style={{textAlign: 'left'}}>renter_id</InputLabel>
        <Select style={{width: '100%',textAlign: 'left'}}
                              labelId ="renter_id"
                              id="renter_id"
                              value={trips.renter_id}
                              onChange ={(e)=>{setTrips({...trips,renter_id:e.target.value});checkErrors()}}>
                              {users.map((key)=><MenuItem key={key.id} value={key.id}>{key.password}</MenuItem>)}
                          </Select>
    </Grid>
<Grid xs={12}  md={6} item key={"30"}>
<Grid container justify={"flex-end"} alignContent={"flex-end"}>
<Button onClick={() => history.push('/trips')} variant={"contained"} type={"Button"} color="secondary">Cancel</Button>
</Grid>
</Grid>
...
export default withRouter(TripsAddUpdatePage)
